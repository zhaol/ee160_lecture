...
int main() {
  ...
  while (exit_program_flag == CONTINUE_PROGRAM) {
    ...
    if (account_type == 's') {
      ...
      printf("This is an invalid account type\n");
      valid_account_type_flag = 0;
      

    }
  
    // try and not print this out if the account type is invalid
